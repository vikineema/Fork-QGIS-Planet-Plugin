...
class PlanetClient(QObject):
    ...
    def __init__(self):
        ...
        # for planet v3.6.0 since without Clientv1 the dispatcher
    ...
    def log_in(self, user, api_key):
        ...
        self.client = Planet(session=Session(auth=self.auth))
    ...
    def list_mosaic_series(self, name_contains=None) -> Iterator[dict[str, dict]]:
        """
    ...
    @waitcursor
    def get_mosaics(self, name_contains=None) -> Iterator[dict[str, dict]]:
        """
